      ...
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        >
          <div className="2xsm:gap-3 flex items-center gap-2">
                  ...
                  <div className="max-h-64 overflow-y-auto p-2">
                    <div className="flex items-center gap-3 rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-gray-800">
                      ...
                      <div className="flex-1">
                        <p className="text-sm text-gray-900 dark:text-white">New invoice received</p>
            ...
            {/* User Menu */}
            <div className="relative">
              <button className="flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800">
                <img
