        ...
        <div className="flex flex-col flex-1 w-full lg:w-1/2">
          ...
          <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div className="mb-5 sm:mb-8">
              <h1 className="mb-2 font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md font-tajawal">إنشاء حساب جديد</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-tajawal">أدخل بياناتك لإنشاء حساب جديد!</p>
            </div>
            <div>
              ...
              <form className="space-y-5">
                ...
                <button type="submit" className="w-full py-3 mt-4 text-sm font-medium text-white bg-brand-500 rounded-lg shadow-theme-xs hover:bg-brand-600 transition-colors font-tajawal">إنشاء حساب</button>
                <div className="text-center mt-4 font-tajawal">
                  <span className="text-gray-500 dark:text-gray-400">لديك حساب بالفعل؟ </span>
                  <Link to="/login" className="text-brand-500 hover:underline">تسجيل الدخول</Link>
                </div>
              </form>
            </div>
          </div>
