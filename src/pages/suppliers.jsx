      ...
      <div className="bg-white dark:bg-[#182235] rounded-xl shadow-sm p-6 mb-6">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex items-center space-x-4 rtl:space-x-reverse">
            ...
            <select
              className="px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-[#182235] dark:text-gray-200"
              value={filterStatus}
